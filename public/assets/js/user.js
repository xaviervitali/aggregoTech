document
  .querySelector("#user_firstname")
  .addEventListener("keyup", (e) => fillUsername(e.target.value));
...
function fillUsername(e) {
  document.querySelector("#user_username").value =
    document
      .querySelector("#user_lastname")
...
/**
 * Partie Canva
 * https://www.jqueryscript.net/demo/Smooth-Signature-Pad-Plugin-with-jQuery-Html5-Canvas/jquery.signaturepad.js
 */
