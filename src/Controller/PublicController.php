...

{
...

    {
        ...
        $rh =  array_filter($userRepository->findBy([], ["firstname" => "ASC"]), function ($user) {
            ...
            return $user->haveRole("ROLE_RH") && $user->getLeaveAt() == NULL;
        });
        ...
        return $this->render('public/equipe.html.twig', ["admins" => $admins, "employees" => $employees, "haveLeave" => $haveLeave, "rh" => $rh]);
    }
