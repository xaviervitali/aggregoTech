 ...
 */
final class Version20220503195320 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE field_category (field_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_D0749E0C12469DE2 (category_id), INDEX IDX_D0749E0C443707B0 (field_id), PRIMARY KEY(field_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
