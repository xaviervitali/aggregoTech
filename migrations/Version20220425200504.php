 ...
 */
final class Version20220425200504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE holiday ADD accepted_by_id INT DEFAULT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD accepted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE holiday ADD CONSTRAINT FK_DC9AB23420F699D9 FOREIGN KEY (accepted_by_id) REFERENCES `user` (id)');
        $this->addSql('CREATE INDEX IDX_DC9AB23420F699D9 ON holiday (accepted_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE holiday DROP FOREIGN KEY FK_DC9AB23420F699D9');
        $this->addSql('DROP INDEX IDX_DC9AB23420F699D9 ON holiday');
        $this->addSql('ALTER TABLE holiday DROP accepted_by_id, DROP created_at, DROP accepted_at, CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE status status VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
